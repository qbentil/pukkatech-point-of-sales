            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control py-2" placeholder="Enter product chasis number"  name="chasisNumber">
                    <div class="valid-feedback"></div>
              ...
              <div class="form-group">
                    ...
                    <input type="text" class="form-control py-2"  placeholder="Enter product part number"  name="partNumber">
                    <div class="valid-feedback"></div>
