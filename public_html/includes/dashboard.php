...
<div class="col-md-6" title = "">
      <a href="?make_sales">
        <div class="card-counter secondary text-black">
    ...
    <div class="col-md-6" title = "Manage Brands">
      <a href="?manage_brands">
        <div class="card-counter primary">
          <i class="fa fa-code-fork"></i>
          <span class="count-numbers"><?php echo (getTotalRecords("brands")-1 )?></span>
          <span class="count-name">Brands</span>
        </div>
      </a>
    </div>

    <div class="col-md-6" title = "Manage Products">
    ...
    <div class="col-md-6" title = "Manage Categories">
      ...
      <div class="card-counter success">
        ...
        <span class="count-numbers"><?php echo getTotalRecords("categories") ?></span>
        <span class="count-name">Categories</span>
      </div>
      </a>
    </div>
    <div class="col-md-6" title = "Manage Sub Categories">
      <a href="?out_of_stock">
    ...
    <div class="col-md-6" title = "Manage Orders">
      <a href="?manage_invoice">
      <div class="card-counter info">
        <i class="fa fa-bar-chart"></i>
        <span class="count-numbers"><?php echo getTotalRecords("invoice") ?></span>
        <span class="count-name">Invoice List</span>
      </div>
      </a>
    </div>
  </div>